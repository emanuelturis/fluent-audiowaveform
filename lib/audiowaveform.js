...
var AudioWaveform = function () {
    ...
    var api = {
        ...
        toPng: function (options) {
            ...
            args = __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], baseArgs), outputFormat), width), height), colors), borderColor), backgroundColor), waveformColor), axisLabelColor);
            return api;
        },
        bits: function (bits) {
            var baseArgs = args;
            var endArgs = ["--bits", "" + bits];
            args = __spreadArray(__spreadArray([], baseArgs), endArgs);
            return api;
        },
        splitChannels: function () {
            var baseArgs = args;
            var endArgs = ["--split-channels"];
            args = __spreadArray(__spreadArray([], baseArgs), endArgs);
            return api;
        },
        pixelsPerSecond: function (zoom) {
            var baseArgs = args;
            var endArgs = ["--pixels-per-second", "" + zoom];
            args = __spreadArray(__spreadArray([], baseArgs), endArgs);
            return api;
        },
